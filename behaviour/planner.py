...
class Planner:
    ...
    def __init__(self, our_side, pitch_num, robotCom):
        ...
        self._defender_current_strategy = self.choose_next_strategy('defender')

        self._attacker_state = 'defending'
        self._attacker_current_strategy = self.choose_next_strategy('attacker')

    # Provisional. Choose the first strategy in the applicable list.
    def choose_next_strategy(self, robot_type):
    ...
    def plan(self, robot='defender'):
        ...
        if robot == 'defender':
            ...
            if not self.in_zone(ball, our_defender.zone):  #and self._defender_state != 'defending':
            ...
            if self.in_zone(ball, their_defender.zone) and self._attacker_state != 'defending':
                self._attacker_state = 'defending'
                self.choose_next_strategy('attacker')
            ...
            elif self.in_zone(ball, our_defender.zone) or self._attacker_state == 'receiving':
